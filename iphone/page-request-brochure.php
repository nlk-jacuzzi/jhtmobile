...
get_header(); ?>	
	...
	<?php if ( wptouch_have_posts() ) { ?>
		...
		<div class="<?php wptouch_post_classes(); ?> page-title-area rounded-corners-8px">
			...
			<h2 role="heading">Request a Brochure</h2>
                                ...
                                <p>
                                    <input data-val="true" data-val-number="The field LeadTypeId must be a number." data-val-required="The LeadTypeId field is required." id="LeadTypeId" name="LeadTypeId" type="hidden" 
                                        value="<?php
                                            ...
                                            echo $leadTypeId;
                                        ?>" />
                                    <input type="hidden" name="fromurl" value="http://www.jacuzzihottubs.com/request-brochure/" />
                                    <input type="submit" class="submit bigBtn" data-role="button" data-theme="a" value="Get My Brochure" /></p>
