		...
		<div class="left">
			...
			<div class="tub-container">
				...
				<div class="tub-shell">
					...
					<img src="<?php echo get_bloginfo('url'); ?>/wp-content/themes/jht/images/lowres-colorselector/shells/porcelain.png" timg="porcelain" height="410" width="576" />
					<img src="<?php echo get_bloginfo('url'); ?>/wp-content/themes/jht/images/lowres-colorselector/shells/sandstone.png" timg="sandstone" height="410" width="576" />
